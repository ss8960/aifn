...
if (!DATABASE_URL) {
  ...
  console.warn("Please create a .env.local file with your database connection string.");
  console.warn("Example: DATABASE_URL=\"postgresql://user:password@host:port/database\"");
}
